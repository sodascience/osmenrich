...
You need to install following libraries to be able to run this example.

```{r, eval=FALSE}
# Install required packages
install.packages(c("tidyverse", "mgcv", "ggspatial", "ggeffects", "sf", "osmenrich"))
# For nice visualization
remotes::install_github("vankesteren/firatheme")
```

Once you installed these libraries, please load them.
...
To demonstrate the usage of `osmenrich`, in this example you will use the dataset of sparrows provided openly by the municipality of Utrecht (The Netherlands).
...
Moving to the data enrichment, you need to make another set of assumptions concerning the behavior of sparrows within Utrecht. You will assume the following:
