...
% the distribution is as follows $\frac{4}{r * \sqrt{2 * \pi}} * \exp{\frac{-(4 * \frac{d}{r})^2}{2}} * I(|(d)| <= r)$
...
Once the `sf` dataset is created, you enrich it using the base syntax:
...
Which, behind the scene uses kernel `"uniform"` and the aggregation function `sum`, as seen below.
